...
export default function LandingClient() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-white border-t border-gray-200 shadow-[0_-4px_20px_rgba(0,0,0,0.08)] px-4 py-3">
        <div className="flex items-center gap-3">
          <div className="flex-1">
            <p className="text-[10px] text-gray-400 font-semibold uppercase tracking-wider">Send money globally</p>
            <p className="text-xs font-bold text-primary">From $1,000 USD</p>
          </div>
          <Link
            href="/login"
            className="flex-1 px-5 py-3 text-sm font-bold bg-primary text-white rounded-xl shadow-lg hover:shadow-xl transition-all active:scale-95 text-center"
          >
            Get Started
          </Link>
        </div>
      ...
      {/* Footer */}
      <footer className="bg-gray-50 w-full py-4 border-t border-gray-200 mt-8 pb-20 md:pb-4">
        ...
        <div className="max-w-6xl mx-auto px-4 lg:px-8 mt-3 pt-3 border-t border-gray-200">
          <p className="text-[10px] text-gray-400 text-center md:text-left">
            RemitX Technologies Ltd. · 14B Admiralty Way, Lekki Phase 1, Lagos 105102, Nigeria
          </p>
        </div>
      </footer>
    </>
